...
/**
 * an abstract class => we will inheritence this class.
 * totalSupply => total money to send money
 */
...
contract NHMToken is StandardToken {
  ...
  string public constant name = "DARWALA";
  ...
  uint256 public constant INITIAL_SUPPLY =  50000000000000000000000; // 50 thousand + 18 decimals
